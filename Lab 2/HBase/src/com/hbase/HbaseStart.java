...
public class HbaseStart
{
	...
	public static void createTable() throws IOException
	{
		...
		config.clear();
         config.set("hbase.zookeeper.quorum", "192.168.133.129");
         config.set("hbase.zookeeper.property.clientPort","2181");
         config.set("hbase.master", "192.168.133.129:60010");
		...
		try {
			// HBaseConfiguration hc = new HBaseConfiguration(new Configuration());
			  ...
			  HTableDescriptor ht = new HTableDescriptor("SensorTagTableGroup6"); 
	...
	public static void insertTable() throws IOException{
		...
		config.clear();
         ...
         String latitude="",longitude="",Date="",x="",y="",z="",humidity="";
		  ...
		  HTable table = new HTable(config, "SensorTagTableGroup6");
        ...
        BufferedReader br = null;
 		...
 		try {
 			...
 			br = new BufferedReader(new FileReader("C://sensor.txt"));
	...
	public static void retrieveTable() throws IOException{
		...
		config.clear();
		 ...
		 Get g = new Get(Bytes.toBytes("row1"));
		  ...
		  byte [] value3 = r.getValue(Bytes.toBytes("humidity"),Bytes.toBytes("col4"));
		  
		  byte [] value4 = r.getValue(Bytes.toBytes("x"),Bytes.toBytes("col5"));
		  
		  byte [] value5 = r.getValue(Bytes.toBytes("y"),Bytes.toBytes("col6"));
		  
		  byte [] value6 = r.getValue(Bytes.toBytes("z"),Bytes.toBytes("col7"));
		  ...
		  System.out.println("GET: " +"humidity: "+ valueStr3);
		  System.out.println("GET: " +"x: "+ valueStr4);
		  System.out.println("GET: " +"y: "+ valueStr5);
		  System.out.println("GET: " +"z: "+ valueStr6);
	...
	public static void deleteTable() throws IOException{
		...
		config.clear();
         ...
         HBaseAdmin admin = new HBaseAdmin(config);
         admin.disableTable("SensorTagTableGroup6");
         admin.deleteTable("SensorTagTableGroup6");
